...
public class NotificaPecBL {
	...
	public static List<NotificaPec> notificheDaInviare(EntityManagerFactory emf, long idUtente) throws Exception {
...
//	public static void creaNotificaNuovoInvioAiResponsabili(EntityManagerFactory emf, JpaController transactionController, long idUtente, MessaggioPec messaggio) throws Exception {
//
//		String destinatari = Configurazione.get(emf).getNotificaInvioDestinatari();
//		String protocollo = messaggio.getProtocollo();
//
//		String prefisso = Configurazione.get(emf).getNotificaPrefissoInvio();
...
//	}
//
//	public static void creaNotificaCambioStatoAdUtente(EntityManagerFactory emf, JpaController transactionController, long idUtente, String stato, MessaggioPec messaggioStato, MessaggioPec messaggioCorrispondente) throws Exception {
//
//		String destinatari = Configurazione.get(emf).getNotificaCambioStatoDestinatari();
//		if (StringUtils.isBlank(destinatari)) {
//			destinatari = messaggioCorrispondente.getEmailMittente();
//		}
//
//		// lo stato contiene gia' i : alla fine
//		String prefisso = Configurazione.get(emf).getNotificaPrefissoCambioStato();
...
//		// Configurazione.get(emf).getNotificaCambioStatoMessaggio());
//		String testo = StringUtils.defaultIfEmpty(messaggioStato.getMessaggio(), Configurazione.get(emf).getNotificaCambioStatoMessaggio());
//
//		if (Configurazione.get(emf).isEnableNotifyStatus()) {
...
//
//				if (stato.equals(MessaggioPecBL.STATO_CONSEGNA))
//					/*
...
//	}
//
//	public static void creaNotificaRicezioneAiResponsabili(EntityManagerFactory emf, JpaController transactionController, long idUtente, MessaggioPec messaggio) throws Exception {
//
//		String destinatari = Configurazione.get(emf).getNotificaInvioDestinatari();
//		String prefisso = Configurazione.get(emf).getNotificaPrefissoRicezione();
//
...
//
//		String protocollo = "";
//		String testo = StringUtils.defaultIfEmpty(messaggio.getMessaggio(), Configurazione.get(emf).getNotificaRicezioneMessaggio());
//
...
//	}
//
//	public static void creaNotificaObsoletoAiResponsabili(EntityManagerFactory emf, JpaController transactionController, long idUtente, MessaggioPec messaggio) throws Exception {
//
//		String destinatari = Configurazione.get(emf).getNotificaInvioDestinatari();
//
//		String prefisso = Configurazione.get(emf).getNotificaPrefissoObsoleto();
...
//		// Configurazione.get(emf).getNotificaObsoletoMessaggio());
//		String testo = StringUtils.defaultIfEmpty(null, Configurazione.get(emf).getNotificaObsoletoMessaggio());
//
...
//	}
//
//	public static void creaNotificaObsoletoAlMittente(EntityManagerFactory emf, JpaController transactionController, long idUtente, MessaggioPec messaggio) throws Exception {
//
//		String destinatari = Configurazione.get(emf).getNotificaCambioStatoDestinatari();
//		if (StringUtils.isBlank(destinatari)) {
...
//	public static void inviaNotifiche(EntityManagerFactory emf, Utente currentUser, boolean useCurrentUserAsSender) throws Exception {
//		// boolean res = false;
//		List<NotificaPec> notificheDaInviare = notificheDaInviare(emf, currentUser.getIdUtente());
//		for (NotificaPec notifica : notificheDaInviare) {
//			// in caso di errore solleva eccezione ed interrompe il ciclo
//			inviaNotifica(emf, notifica, currentUser, useCurrentUserAsSender);
//		}
//		// res = true;
//		// return res;
//	}
...
//	// }
//
//	public static boolean creaNotificaInoltro(EntityManagerFactory emf, JpaController transactionController, long idUtente, Messaggio messaggioInoltro) throws Exception {
//		boolean res = false;
//
//		String destinatari = messaggioInoltro.getInoltratoDestinatari();
//
//		if (StringUtils.isNotBlank(Configurazione.get(emf).getNotificaInoltroDestinatari())) {
//			if (StringUtils.isBlank(destinatari))
//				destinatari = Configurazione.get(emf).getNotificaInoltroDestinatari();
//			else
//				destinatari = destinatari + ", " + Configurazione.get(emf).getNotificaInoltroDestinatari();
//		}
//
//		messaggioInoltro.setInoltratoDestinatari(destinatari);
//
//		String prefisso = Configurazione.get(emf).getNotificaPrefissoInoltro();
...
//	}
//
//	public static void inviaNotifica(EntityManagerFactory emf, NotificaPec notifica, Utente currentUser, boolean useCurrentUserAsSender) throws Exception {
//
//		Configurazione.reloadCurrent();
//
//		if (Configurazione.get(emf).isEnableNotifySend()) {
//
//			String smtpServer = Configurazione.get(emf).getSmtpServerNotifiche();
//			int smtpPort = Configurazione.get(emf).getSmtpPortNotifiche();
//			String senderEmail = Configurazione.get(emf).getSenderEmailNotifiche();
//			String senderName = Configurazione.get(emf).getSenderNameNotifiche();
//
//			if (currentUser != null && useCurrentUserAsSender) {
//				senderEmail = StringUtils.defaultIfBlank(currentUser.getEmail1(), senderEmail);
//				senderName = StringUtils.defaultIfBlank(currentUser.getCognomeNome(), senderName);
//			}
//
//			// String smtpUsername =
...
//
//			// String destinatari =
//			// Configurazione.get(emf).getNotificaInvioDestinatari();
